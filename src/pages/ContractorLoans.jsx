...
const ContractorLoans = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Mortgage for Contractors | Self-Employed Contractor Mortgage</title>
        <meta name="description" content="Mortgages for self-employed contractors. Qualify using bank statements or 1099s even with heavy tax write-offs." />
      </Helmet>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem' }}>
              <div style={{ padding: '2rem', backgroundColor: 'var(--bg-color)', borderRadius: 'var(--radius)' }}>
                ...
                <p style={{ color: 'var(--text-secondary)', lineHeight: 1.6 }}>
                  General contractors often manage massive budgets, but sub-contractor payouts and heavy material costs can decimate net income on a tax return. We understand the GC business model. Many GCs choose our <Link to="/bank-statement-loans">Bank Statement Loan</Link> program because it allows lenders to evaluate recent gross business deposits rather than relying solely on older, heavily deducted tax returns.
                </p>
              </div>
              ...
              <div style={{ padding: '2rem', backgroundColor: 'var(--bg-color)', borderRadius: 'var(--radius)' }}>
                ...
                <p style={{ color: 'var(--text-secondary)', lineHeight: 1.6 }}>
                  Landscaping contractors are notorious for heavy equipment depreciation. From zero-turn mowers to dump trailers, your tax returns are designed to show minimal profit to save you money. If you receive a large portion of your income via <Link to="/1099-loans">1099s</Link> from commercial clients, we can use those forms directly to qualify you for your next home.
                </p>
              </div>
        ...
        <section className="section bg-color" style={{ paddingTop: '2rem', paddingBottom: '4rem' }}>
          <div className="container" style={{ textAlign: 'center', borderTop: '1px solid rgba(0,0,0,0.1)', paddingTop: '4rem' }}>
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '1rem', justifyContent: 'center' }}>
              <Link to="/self-employed-programs" style={{ padding: '0.5rem 1rem', backgroundColor: 'rgba(30,58,138,0.05)', borderRadius: '999px', color: 'var(--primary)', textDecoration: 'none', fontSize: '0.9rem', fontWeight: '500' }}>Self-Employed Mortgage Programs</Link>
              <Link to="/bank-statement-loans" style={{ padding: '0.5rem 1rem', backgroundColor: 'rgba(30,58,138,0.05)', borderRadius: '999px', color: 'var(--primary)', textDecoration: 'none', fontSize: '0.9rem', fontWeight: '500' }}>Bank Statement Loans</Link>
              <Link to="/1099-loans" style={{ padding: '0.5rem 1rem', backgroundColor: 'rgba(30,58,138,0.05)', borderRadius: '999px', color: 'var(--primary)', textDecoration: 'none', fontSize: '0.9rem', fontWeight: '500' }}>1099 Loans</Link>
              <Link to="/mortgage-for-llc" style={{ padding: '0.5rem 1rem', backgroundColor: 'rgba(30,58,138,0.05)', borderRadius: '999px', color: 'var(--primary)', textDecoration: 'none', fontSize: '0.9rem', fontWeight: '500' }}>LLC Owner Mortgages</Link>
              <Link to="/mortgage-for-scorp" style={{ padding: '0.5rem 1rem', backgroundColor: 'rgba(30,58,138,0.05)', borderRadius: '999px', color: 'var(--primary)', textDecoration: 'none', fontSize: '0.9rem', fontWeight: '500' }}>S-Corp Mortgages</Link>
            </div>
          </div>
        </section>
