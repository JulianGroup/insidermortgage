...
const Loans1099 = () => {
  ...
  return (
    <>
      <Helmet>
        <title>1099 Mortgage Loan for Contractors & Freelancers | Insider Mortgage</title>
        <meta name="description" content="Get approved for a 1099 mortgage loan using only your tax forms. Designed for freelancers, contractors, and gig workers." />
      </Helmet>
